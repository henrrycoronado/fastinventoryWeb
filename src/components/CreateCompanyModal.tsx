          ...
          {step === 'company' && (
            <>
              <div>
                ...
                <input className="input" placeholder="Ej: Zapatería StepUp" value={companyName} onChange={e => setCompanyName(e.target.value)} autoFocus />
              </div>
              <div>
                <label className="label">Confirmar acción</label>
                <input className={`input ${passwordError ? 'border-red-500 focus:ring-red-500' : ''}`} type="password" placeholder="Escribe: confirmar" value={password} onChange={e => { setPassword(e.target.value); setPasswordError(false) }} />
          ...
          {step === 'warehouse' && (
            <>
              ...
              <div>
                ...
                <input className="input" placeholder="Ej: Sucursal Centro" value={warehouseName} onChange={e => setWarehouseName(e.target.value)} autoFocus />
              </div>
              <div className="flex justify-end gap-2 pt-1">
