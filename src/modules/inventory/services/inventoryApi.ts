...
export const inventoryApi = {
  ...
  units: {
    ...
    create: (companyCen: string, data: { name: string; abbreviation: string }) =>
      apiClient.post<Unit>(`/api/inventory/companies/${companyCen}/units`, data).then(r => r.data),
    update: (companyCen: string, unitCen: string, data: { name: string; abbreviation: string }) =>
      apiClient.put<Unit>(`/api/inventory/companies/${companyCen}/units/${unitCen}`, data).then(r => r.data),
  },
  ...
  products: {
    ...
    lookup: (companyCen: string, data: { productCens: string[] }) =>
      apiClient.post<Product[]>(`/api/inventory/companies/${companyCen}/products/lookup`, data).then(r => r.data),
  ...
  stock: {
    ...
    validate: (companyCen: string, data: any) =>
      apiClient.post<any>(`/api/inventory/companies/${companyCen}/stock/validate`, data).then(r => r.data),
    consume: (companyCen: string, data: any) =>
      apiClient.post<any>(`/api/inventory/companies/${companyCen}/stock/consume`, data).then(r => r.data),
    increase: (companyCen: string, data: any) =>
      apiClient.post<string>(`/api/inventory/companies/${companyCen}/stock/increase`, data).then(r => r.data),
    adjustment: (companyCen: string, data: any) =>
      apiClient.post<any>(`/api/inventory/companies/${companyCen}/stock/adjustments`, data).then(r => r.data),
  },
